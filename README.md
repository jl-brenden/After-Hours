...
# Core Gameplay
- Box sorting animations will also play when the player Presses 'E' on a certain platform next to a conveyor belt and will provide the player with a box to go into the rest of the warehouse to place someones "amazon order"
